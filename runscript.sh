set -v
make
./fprun global_outputs/$1-output.txt answers/$1-output.txt | tee log/$1.log
...
# python3 utils/draw_floorplan.py ~/Desktop/Global_Floorplanning/inputs/$1-input.txt ./answers/$1-output.txt ./outputs/floorplan_$1.png