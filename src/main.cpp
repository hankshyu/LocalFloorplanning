...
int main(int argc, char const *argv[]) {
    ...
    //     700., 500., 300., 100.,
    //     70., 50., 30., 10., 7., 5., 3., 1.,
    //     0.7, 0.5, 0.3, 0.1, 0.07, 0.05, 0.03, 0.01,
    //     0.007, 0.005, 0.003, 0.001
    //     };

    // std::vector<double> toleranceLengthValues{
    //     0,
    //     (rgparser.getDieWidth() + rgparser.getDieHeight()) / 800.,
    //     (rgparser.getDieWidth() + rgparser.getDieHeight()) / 400.,
    //     (rgparser.getDieWidth() + rgparser.getDieHeight()) / 200.
    // };
