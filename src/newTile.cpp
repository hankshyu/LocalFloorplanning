...
Tile::Tile()
    : type(tileType::BLANK), mTessIndex(-1),
        rt(nullptr), tr(nullptr), bl(nullptr), lb(nullptr) {
            mRectangle = gtl::construct((len_t) 0, (len_t) 0, (len_t) 0, (len_t) 0);
        }
...
Tile::Tile(tileType t, Rectangle& r, int index) 
    : type(t), mTessIndex(index), rt(nullptr), tr(nullptr), bl(nullptr), lb(nullptr) {
